...
import com.elfangor1989.FreeLiveView.messages.calls.SetLed;
import com.elfangor1989.FreeLiveView.messages.calls.SetScreenMode;
import com.elfangor1989.FreeLiveView.messages.calls.SetVibrate;
...
public class LiveViewService extends Service
{
    ...
    final public static String PLUGIN_COMMAND   = "com.elfangor1989.FreeLiveView.plugin.command";
    ...
    private BroadcastReceiver media_receiver = new BroadcastReceiver()
    {
    	...
    	Log.d("FLV Music","Artist: "+MediaInfoArtist+", Album: "+MediaInfoAlbum+" and Track: "+MediaInfoTrack);
    	}
    	};
