...
import com.elfangor1989.FreeLiveView.ConfigWizardActivity;
...
public class BTReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (address == null) {
            ...
            Toast.makeText(context, "No LiveView device configured! Please configure FLV by opening the app.", Toast.LENGTH_SHORT).show();
        } else {
