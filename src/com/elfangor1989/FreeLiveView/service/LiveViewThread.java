...
import com.elfangor1989.FreeLiveView.LiveViewPreferences;
import com.elfangor1989.FreeLiveView.MainActivity;
import com.elfangor1989.FreeLiveView.R;
import com.elfangor1989.FreeLiveView.data.LiveViewDbConstants;
import com.elfangor1989.FreeLiveView.data.LiveViewDbHelper;
import com.elfangor1989.FreeLiveView.data.Prefs;
import com.elfangor1989.FreeLiveView.messages.*;
import com.elfangor1989.FreeLiveView.messages.calls.*;
import com.elfangor1989.FreeLiveView.messages.events.CapsResponse;
import com.elfangor1989.FreeLiveView.messages.events.DeviceStatus;
import com.elfangor1989.FreeLiveView.messages.events.GetAlert;
import com.elfangor1989.FreeLiveView.messages.events.Navigation;
...
public class LiveViewThread extends Thread {
    ...
    private String PLUGIN_EVENT = "com.elfangor1989.FreeLiveView.plugin.event";
    ...
    private void processEvent(LiveViewEvent event) throws IOException {
        ...
        //Log.d(TAG, "FLV will now process an event with id: " + event.getId());
        switch (event.getId()) {
